...
class Login extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->session->unset_userdata('ses_pekerjaan');
        $this->session->unset_userdata('ses_wilayah');
    ...
    public function sign_in(){
        ...
        if ($cek_login == 1){
            ...
            $this->session->set_userdata('ses_nama',$tampil['username']);
            $this->session->set_userdata('ses_pekerjaan',$tampil['pekerjaan']);
            $this->session->set_userdata('ses_foto',$tampil['foto']);
            $this->session->set_userdata('ses_wilayah',$tampil['wilayah']);
            redirect('dashboard');
        }else{
    ...
    public function sign_out(){
        ...
        $this->session->unset_userdata('ses_wilayah');
        $this->session->set_flashdata('sukses', 'Terimakasih Telah Menggunakan Aplikasi e-gov Maturity');
        redirect('login');
    }
